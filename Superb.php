	...
	<div class="container">
        ...
        <div style="width: 100%;" class="panel panel-default slideUp">
          <div class="panel-heading">
                <h3 class="panel-title" style="font-size: 0.9vw;"><span aria-hidden="true"></span>Škoda SuperB</h3>
          </div>
		  <div class="panel-body">
            <div style="color: #d7ba40; font-size: 0.9vw; width: 40%; margin-right: 0px; float:left;">
				<img src="SuperB.jpg" alt="Skoda Super B" style="width:100%">
            </div>
			<div style="color: #d7ba40; font-size: 0.9vw; width: 20%; float:left; margin: 5%; margin-top: 1%;">
				 <ul>
    				<li>Marka pojazdu: 		Škoda</li>
    				<li>Model pojazdu: 		Superb</li>
					<li>Wersja:				III (2015-)</li>
    				<li>Rok produkcji:		2019</li>
    				<li>Pojemność skokowa:	2 000 cm3</li>
    				<li>Rodzaj paliwa:		Diesel</li>
    				<li>Moc:				190 KM</li>
    				<li>Skrzynia biegów:	Automatyczna dwusrzęgłowa (DCT, DSG)</li>
    				<li>Napęd:				4x4(dołączany automatycznie)</li>
    				<li>Typ:				Sedan</li>
