	...
	<div class="container">
        ...
        <div style="width: 100%;" class="panel panel-default slideUp">
          <div class="panel-heading">
                <h3 class="panel-title" style="font-size: 0.9vw;"><span aria-hidden="true"></span>Peugeot 3008</h3>
          </div>
		  <div class="panel-body">
            <div style="color: #d7ba40; font-size: 0.9vw; width: 40%; margin-right: 0px; float:left;">
				<img src="3008.jpg" alt="3008" style="width:100%">
            </div>
			<div style="color: #d7ba40; font-size: 0.9vw; width: 50%; float:left; margin: 5%; margin-top: 1%;">
				 <ul>
    				<li>Marka pojazdu: 		Peugeot</li>
    				<li>Model pojazdu: 		3008</li>
    				<li>Rok produkcji:		2019</li>
    				<li>Wersja:				II (2016-)</li>
    				<li>Pojemność skokowa:	1 199 cm3</li>
