	...
	<div class="container">
        ...
        <div style="width: 100%;" class="panel panel-default slideUp">
          <div class="panel-heading">
                <h3 class="panel-title" style="font-size: 0.9vw;"><span aria-hidden="true"></span>Škoda Octavia</h3>
          </div>
		  <div class="panel-body">
            <div style="color: #d7ba40; font-size: 0.9vw; width: 40%; margin-right: 0px; float:left;">
				<img src="Octavia.png" alt="Skoda Octavia" style="width:100%">
            </div>
			<div style="color: #d7ba40; font-size: 0.9vw; width: 20%; float:left; margin: 5%; margin-top: 1%;">
				 <ul>
    				<li>Marka pojazdu: 		Škoda</li>
    				<li>Model pojazdu: 		Octavia</li>
					<li>Wersja:				III (2013-)</li>
